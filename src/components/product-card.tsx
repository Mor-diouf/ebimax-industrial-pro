  ...
  return (
    <article className="group overflow-hidden border border-border bg-card transition-all hover:-translate-y-1 hover:shadow-product">
      ...
      <div className="p-5">
        ...
        <h3 className="mt-3 min-h-14 font-display text-xl font-bold leading-tight text-card-foreground">
          {product.title}
        </h3>
        {product.description ? (
        ...
        <div className="mt-5 flex items-end justify-between gap-3">
          <div>
            ...
            <p className="font-display text-xl font-black text-foreground">{product.price}</p>
          </div>
          <div className="flex gap-2">
            ...
            <Button asChild size="icon" aria-label={`Demander un devis pour ${product.title}`}>
        ...
        <Link
          ...
          className="mt-4 flex items-center justify-between border-t border-border pt-4 text-xs font-bold uppercase text-muted-foreground hover:text-primary"
        >
          <span>Voir le rayon</span>
